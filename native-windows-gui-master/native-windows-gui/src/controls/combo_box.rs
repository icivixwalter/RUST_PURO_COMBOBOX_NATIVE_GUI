...
```rust
use native_windows_gui as nwg; usa native_windows_gui come nwg;
...
impl<D: Display+Default> ComboBox<D> {
    ...
    //
    // Common control functions Funzioni di controllo comuni
    //
    ...
    /// Winapi class name used during control creation - Nome della classe Winapi utilizzato durante la creazione del controllo
