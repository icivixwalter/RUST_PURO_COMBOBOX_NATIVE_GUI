...
Benvenuti nella GUI di Windows nativa (aka NWG). Una libreria ruggine per sviluppare applicazioni GUI 
native sul desktop per Microsoft Windows.
...
NWG � un wrapper molto leggero su WINAPI. Consente a te, lo sviluppatore, di gestire
le stranezze e gli spigoli dell'API fornendo un'interfaccia semplice, sicura e simile alla ruggine.
...
La GUI nativa di Windows semplifica le cose. Ci� significa tempi di compilazione ridotti, utilizzo minimo delle risorse,
meno tempo per la ricerca nella documentazione e pi� tempo per lo sviluppo della tua applicazione


Certo, non devi credermi sulla parola, dai un'occhiata a....
...
Questa � la terza e ultima versione di NWG. � considerato "maturo" o, come direi
"l'arretrato � vuoto e molto probabilmente rimarr� tale". Questa versione implementa praticamente
tutto il necessario per sviluppare applicazioni su Windows. Non preoccuparti di usare le versioni precedenti come loro
hanno "decisioni di progettazione inconciliabili" e non possono supportare alcune funzionalit� chiave. Lo sviluppo futuro sar� fatto
...
Se sei riuscito a leggere questa introduzione, dovresti sapere che il mio twitter gestisce

is [#gdube_dev](https://twitter.com/gdube_dev) 
and you can support this project with [*GitHub Sponsors*](https://github.com/sponsors/gabdube).
e puoi sostenere questo progetto con
...
Guarda tu stesso. NWG ha molti esempi e una suite di test completamente interattiva. L'unica cosa che devi fare �:
...
L'esecuzione dei test dall'area di lavoro rovina le funzionalit�
...
//TUTTA questa roba è gestita da native-windows-derive
//
mod basic_app_ui {
